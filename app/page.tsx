    ...
    <div className="flex min-h-screen">
      <nav className="w-64 bg-gray-800 text-white p-6">
        <ul className="space-y-4">
          <li className={pathname === "/practice" ? "font-bold" : ""}>
            <Link href="/practice" className="hover:text-blue-300">
              Practice
            </Link>
          </li>
          <li className={pathname === "/play-globally" ? "font-bold" : ""}>
            <Link href="/play-globally" className="hover:text-blue-300">
              Play Globally
            </Link>
          </li>
          <li className={pathname === "/play-with-friends" ? "font-bold" : ""}>
            <Link href="/play-with-friends" className="hover:text-blue-300">
              Play with Friends
            </Link>
          </li>
          <li className={pathname === "/leaderboard" ? "font-bold" : ""}>
